...
s = float(input('Qual o modulo do vetor de defasagem do elo a? '))
p = float(input('Qual o modulo do vetor de defasagem do elo b? '))
u = float(input('Qual o modulo do vetor de defasagem do elo c? '))
